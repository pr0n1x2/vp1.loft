...
if (isset($_POST['action']) && $_POST['action'] == 'order') {
    ...
    if ($result === true) {
        echo '<p style="text-align: center; color: green; font-size: 28px;">Ваш заказ был успешно принят!</p>';
        die();
    }
}
...
<html lang="ru">
  ...
  <body>
    <?php
    if ($result !== false) {
        echo '<div class="global_errors">' . $result . '</div>';
    }
    ?>
    <div class="wrapper">
                ...
                <div class="order__form-col">
                  <div class="order__form-row order__form-row_double">
                    <label class="order__form-block">
                      ...
                      <input class="order__form-input" name="name" type="text" value="<?= $_POST['name'] ?>">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Телефон</div>
                      <input class="order__form-input phone-mask" name="phone" type="text" value="<?= $_POST['phone'] ?>">
                    </label>
                  </div>
                  <div class="order__form-row order__form-row_double">
                    <label class="order__form-block">
                      <div class="order__form-label">email</div>
                      <input class="order__form-input" name="email" type="email" value="<?= $_POST['email'] ?>">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Улица</div>
                      <input class="order__form-input" name="street" type="text" value="<?= $_POST['street'] ?>">
                    </label>
                  </div>
                  <div class="order__form-row order__form-row_quatro">
                    <label class="order__form-block">
                      <div class="order__form-label">Дом</div>
                      <input class="order__form-input" name="home" type="text" value="<?= $_POST['home'] ?>">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Корпус</div>
                      <input class="order__form-input" name="part" type="text" value="<?= $_POST['part'] ?>">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Квартира</div>
                      <input class="order__form-input" name="appt" type="text" value="<?= $_POST['appt'] ?>">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Этаж</div>
                      <input class="order__form-input" name="floor" type="text" value="<?= $_POST['floor'] ?>">
                    </label>
                  </div>
                </div>
                <div class="order__form-col">
                  <div class="order__form-row">
                    <label class="order__form-block">
                      ...
                      <textarea class="order__form-input order__form-input_textarea" name="comment"><?= $_POST['comment'] ?></textarea>
                    </label>
                  </div>
